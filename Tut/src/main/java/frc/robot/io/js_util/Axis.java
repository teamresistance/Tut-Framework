 ...
 * 
 * Description:
 * This class allows for the creation of an object to represent an axis for a joystick.
 * 
 * Also, allows use of various joystick/gamepad configurations because an Axis object can be 
 * any type of joystick on a joystick/gamepad.
 * 
 * Constructor gets JS_ID and axisID.  However, if the it needs to pass a default (axis may not
